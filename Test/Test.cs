...
namespace Test
{
    ...
    public class Test : IClassFixture<DotNetFixture>
    {
        ...
        public void TestArchitecture(string lang, bool skipRestore)
        {
            ...
            var filesToCheck = new List<string> { ".gitignore", "module.json", "Dockerfile.amd64", "Dockerfile.amd64.debug", "Dockerfile.arm32v7", "Dockerfile.arm32v7.debug", "Dockerfile.windows-amd64", "Dockerfile.arm64v8", "Dockerfile.arm64v8.debug" };
